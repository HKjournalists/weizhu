...
public class SocketConnectionTest {
	...
	private static final ByteString sessionKey = ByteString.copyFrom(HexUtil.hex2bin("72b0a67e4f282d06121f3bbb1a9629de69208018da3085557cde6ab7405a1d0a"));
	...
	public static void init() {
		...
		// socketConn.connect(new InetSocketAddress("127.0.0.1", 8091), sessionKey, 0);
		
		socketConn.connect(new InetSocketAddress("112.126.80.93", 8095), sessionKey, 0);
	...
	public void test() throws Throwable {
		...
		System.out.println("user : " + response.getUser(0).getBase().getUserName());

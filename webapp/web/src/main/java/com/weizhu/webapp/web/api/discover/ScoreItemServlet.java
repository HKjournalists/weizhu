...
@Singleton
public class ScoreItemServlet extends HttpServlet {
	...
	@Inject
	public ScoreItemServlet(Provider<RequestHead> requestHeadProvider, DiscoverV2Service discoverV2Service) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		ScoreItemResponse response = Futures.getUnchecked(discoverV2Service.scoreItem(head, ScoreItemRequest.newBuilder()
				.setItemId(itemId)
				.setScore(score)
				.build()));

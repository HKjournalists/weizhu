...
public class SubmitExamServlet extends HttpServlet {
	...
	@Inject
	public SubmitExamServlet(Provider<RequestHead> requestHeadProvider, ExamService examService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		SubmitExamResponse response = Futures.getUnchecked(this.examService.submitExam(head, request));

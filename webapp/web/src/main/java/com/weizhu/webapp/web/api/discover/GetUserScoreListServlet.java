...
public class GetUserScoreListServlet extends HttpServlet {
	...
	@Inject
	public GetUserScoreListServlet(Provider<RequestHead> requestHeadProvider, DiscoverV2Service discoverV2Service,
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		GetUserScoreListResponse response = Futures.getUnchecked(discoverV2Service.getUserScoreList(head, requestBuilder.build()));

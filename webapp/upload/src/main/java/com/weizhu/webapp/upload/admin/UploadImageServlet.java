...
public class UploadImageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		if (response.getResult() == UploadImageResponse.Result.SUCC) {
			...
			GetUploadUrlPrefixResponse urlPrefixResponse = Futures.getUnchecked(this.uploadService.getUploadUrlPrefix(head, ServiceUtil.EMPTY_REQUEST));
			
			obj.addProperty("image_url", urlPrefixResponse.getImageUrlPrefix() + image.getName());
			obj.addProperty("image_60_url", urlPrefixResponse.getImage60UrlPrefix() + image.getName());
			obj.addProperty("image_120_url", urlPrefixResponse.getImage120UrlPrefix() + image.getName());
			obj.addProperty("image_240_url", urlPrefixResponse.getImage240UrlPrefix() + image.getName());
			obj.addProperty("image_480_url", urlPrefixResponse.getImage480UrlPrefix() + image.getName());

...
public class UploadDiscoverAudioServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		Audio audio = this.getAudioInfo(companyId, tmpFile, md5, size);
		if (audio == null) {
			JsonObject obj = new JsonObject();
			obj.addProperty("result", "FAIL_UNKNOWN");
	...
	private Audio getAudioInfo(long companyId, File audioFile, String md5, int size) {
		...
		String name = companyId + "/discover/audio/" + md5 + "." + type;

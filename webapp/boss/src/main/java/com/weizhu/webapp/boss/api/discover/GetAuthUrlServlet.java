...
public class GetAuthUrlServlet extends HttpServlet {
	...
	@Inject
	public GetAuthUrlServlet(Provider<BossHead> bossHeadProvider, SystemService systemService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		final Long companyId = ParamUtil.getLong(httpRequest, "company_id", null);

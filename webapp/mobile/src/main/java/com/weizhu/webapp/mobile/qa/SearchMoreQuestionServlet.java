...
public class SearchMoreQuestionServlet extends HttpServlet {
	...
	@Inject
	public SearchMoreQuestionServlet(Provider<RequestHead> requestHeadProvider, QAService qaService, UserService userService, UploadService uploadService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		QAProtos.SearchMoreQuestionRequest.Builder requestBuilder = QAProtos.SearchMoreQuestionRequest.newBuilder();
		...
		QAProtos.SearchMoreQuestionResponse response = Futures.getUnchecked(this.qaService.searchMoreQuestion(head, requestBuilder.build()));
		//获取用户信息

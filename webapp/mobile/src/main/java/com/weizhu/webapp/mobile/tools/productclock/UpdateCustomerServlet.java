...
public class UpdateCustomerServlet extends HttpServlet {
	...
	@Inject
	public UpdateCustomerServlet(Provider<RequestHead> requestHeadProvider, ToolsProductclockService toolsProductclockService) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		UpdateCustomerResponse response = Futures.getUnchecked(toolsProductclockService.updateCustomer(requestHead, requestBuilder.build()));

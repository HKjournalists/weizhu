...
public class GetTrainByIdServlet extends HttpServlet {
	...
	@Inject
	public GetTrainByIdServlet(Provider<RequestHead> requestHeadProvider, 
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		GetTrainByIdResponse response = Futures.getUnchecked(this.offlineTrainingService.getTrainById(head, request));

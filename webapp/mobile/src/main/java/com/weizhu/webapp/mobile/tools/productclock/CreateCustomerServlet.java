...
public class CreateCustomerServlet extends HttpServlet {
	...
	@Inject
	public CreateCustomerServlet(Provider<RequestHead> requestHeadProvider, ToolsProductclockService toolsProductclockService) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		CreateCustomerResponse response = Futures.getUnchecked(toolsProductclockService.createCustomer(requestHead, builder.build()));

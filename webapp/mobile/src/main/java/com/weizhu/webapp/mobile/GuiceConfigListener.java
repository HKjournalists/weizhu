...
public class GuiceConfigListener extends GuiceServletContextListener {
	...
	static {
		if (System.getProperty("logback.configurationFile") == null) {
			System.setProperty("logback.configurationFile", "com/weizhu/webapp/mobile/logback.xml");
		}
	}
	...
	public static class WebappModule extends AbstractModule {
		...
		protected void configure() {
			...
			install(new MobileServletModule());
			...
			install(new RpcServiceModule(ToolsService.class, "company_proxy_server"));
			...
			install(new RpcServiceModule(OfflineTrainingService.class, "company_proxy_server"));
			install(new RpcServiceModule(ComponentService.class, "company_proxy_server"));
	...
	private final Injector injector = Guice.createInjector(
			...
			System.getProperty("server.conf") != null ? 
					new ConfModule() : 
					new ConfModule(Resources.getResource("com/weizhu/webapp/mobile/test.conf"))
			, 
			new WebappModule()
			);

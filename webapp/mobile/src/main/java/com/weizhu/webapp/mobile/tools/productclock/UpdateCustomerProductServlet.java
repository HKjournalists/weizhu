...
public class UpdateCustomerProductServlet extends HttpServlet {
	...
	@Inject
	public UpdateCustomerProductServlet(Provider<RequestHead> requestHeadProvider, ToolsProductclockService toolsProductclockService) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		UpdateCustomerProductResponse response = Futures.getUnchecked(toolsProductclockService.updateCustomerProduct(requestHead, requestBuilder.build()));

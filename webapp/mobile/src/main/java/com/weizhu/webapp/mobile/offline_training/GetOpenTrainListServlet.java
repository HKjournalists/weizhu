...
public class GetOpenTrainListServlet extends HttpServlet {
	...
	@Inject
	public GetOpenTrainListServlet(Provider<RequestHead> requestHeadProvider, 
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		GetOpenTrainListRequest.Builder requestBuilder = GetOpenTrainListRequest.newBuilder();
		requestBuilder.setSize(size);
		if (offsetIndex != null) {
			requestBuilder.setOffsetIndex(offsetIndex);
		}
		
		GetOpenTrainListResponse response = Futures.getUnchecked(this.offlineTrainingService.getOpenTrainList(head, requestBuilder.build()));

...
public class CreateUserInfoServlet extends HttpServlet {
	...
	@Inject
	public CreateUserInfoServlet(HikariDataSource hikariDataSource) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		try {
			...
			pstmt = conn.prepareStatement("INSERT INTO weizhu_home_user_info (user_name, position, email, phone, company, province, city, remark) VALUES (?, ?, ?, ?, ?, ?, ?, ?); ");

...
@Singleton
public class GetCreditsRuleServlet extends HttpServlet {
	...
	@Inject
	public GetCreditsRuleServlet(Provider<AdminHead> adminHeadProvider, AdminCreditsService adminCreditsService) {

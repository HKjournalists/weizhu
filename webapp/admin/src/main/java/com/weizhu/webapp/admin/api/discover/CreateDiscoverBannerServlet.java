...
public class CreateDiscoverBannerServlet extends HttpServlet {
	
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminDiscoverService adminDiscoverService;

	@Inject
	public CreateDiscoverBannerServlet(Provider<AdminHead> adminHeadProvider, AdminDiscoverService adminDiscoverService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminDiscoverProtos.CreateBannerRequest.Builder requestBuilder = AdminDiscoverProtos.CreateBannerRequest.newBuilder()
		...
		AdminDiscoverProtos.CreateBannerResponse response = Futures.getUnchecked(this.adminDiscoverService.createBanner(head, requestBuilder.build()));

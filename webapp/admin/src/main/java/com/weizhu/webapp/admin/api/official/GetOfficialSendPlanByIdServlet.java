...
public class GetOfficialSendPlanByIdServlet extends HttpServlet {
	...
	@Inject
	public GetOfficialSendPlanByIdServlet(Provider<AdminHead> adminHeadProvider, 
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		GetOfficialSendPlanByIdRequest request = GetOfficialSendPlanByIdRequest.newBuilder()
				.addAllPlanId(planIdList)
				.build();
		
		GetOfficialSendPlanByIdResponse response = Futures.getUnchecked(adminOfficialService.getOfficialSendPlanById(head, request));

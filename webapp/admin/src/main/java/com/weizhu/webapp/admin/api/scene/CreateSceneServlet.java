...
public class CreateSceneServlet extends HttpServlet {
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminSceneService adminSceneService;

	@Inject
	public CreateSceneServlet(Provider<AdminHead> adminHeadProvider, AdminSceneService adminSceneService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminSceneProtos.CreateSceneRequest.Builder request = AdminSceneProtos.CreateSceneRequest.newBuilder()
		...
		AdminSceneProtos.CreateSceneResponse response = Futures.getUnchecked(this.adminSceneService.createScene(this.adminHeadProvider.get(),
				request.build()));

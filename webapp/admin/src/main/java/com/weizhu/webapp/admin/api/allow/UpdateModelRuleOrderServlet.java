...
@Singleton
public class UpdateModelRuleOrderServlet extends HttpServlet {
	...
	@Inject
	public UpdateModelRuleOrderServlet(Provider<AdminHead> adminHeadProvider, AllowService allowService) {

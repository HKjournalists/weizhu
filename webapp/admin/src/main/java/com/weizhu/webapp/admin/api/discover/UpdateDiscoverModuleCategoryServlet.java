...
public class UpdateDiscoverModuleCategoryServlet extends HttpServlet {
	
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminDiscoverService adminDiscoverService;

	@Inject
	public UpdateDiscoverModuleCategoryServlet(Provider<AdminHead> adminHeadProvider, AdminDiscoverService adminDiscoverService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminDiscoverProtos.UpdateModuleCategoryRequest.Builder requestBuilder = AdminDiscoverProtos.UpdateModuleCategoryRequest.newBuilder()
		...
		AdminDiscoverProtos.UpdateModuleCategoryResponse response = Futures.getUnchecked(this.adminDiscoverService.updateModuleCategory(head, requestBuilder.build()));

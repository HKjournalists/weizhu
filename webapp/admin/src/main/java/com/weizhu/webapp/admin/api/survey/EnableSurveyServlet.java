...
@Singleton
public class EnableSurveyServlet extends HttpServlet {
	...
	@Inject
	public EnableSurveyServlet(Provider<AdminHead> adminHeadProvider, SurveyService surveyService) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		EnableSurveyRequest request = EnableSurveyRequest.newBuilder()
				.addAllSurveyId(surveyIdList)
				.build();
		
		final AdminHead adminHead = adminHeadProvider.get();
		
		EnableSurveyResponse response = Futures.getUnchecked(surveyService.enableSurvey(adminHead, request));

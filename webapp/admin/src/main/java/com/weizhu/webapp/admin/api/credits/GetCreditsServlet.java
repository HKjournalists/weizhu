...
public class GetCreditsServlet extends HttpServlet {
	...
	@Inject
	public GetCreditsServlet(Provider<AdminHead> adminHeadProvider, AdminCreditsService adminCreditsService) {
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws IOException {
		...
		GetCreditsResponse response = Futures.getUnchecked(adminCreditsService.getCredits(adminHead, EmptyRequest.getDefaultInstance()));

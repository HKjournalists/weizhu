...
public class CreateTrainServlet extends HttpServlet {
	...
	@Inject
	public CreateTrainServlet(Provider<AdminHead> adminHeadProvider, 
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		CreateTrainRequest.Builder requestBuilder = CreateTrainRequest.newBuilder();
		...
		CreateTrainResponse response = Futures.getUnchecked(this.adminOfflineTrainingService.createTrain(head, requestBuilder.build()));

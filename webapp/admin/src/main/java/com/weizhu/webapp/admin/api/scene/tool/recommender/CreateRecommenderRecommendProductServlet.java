...
public class CreateRecommenderRecommendProductServlet extends HttpServlet {
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminSceneService adminSceneService;

	@Inject
	public CreateRecommenderRecommendProductServlet(Provider<AdminHead> adminHeadProvider, AdminSceneService adminSceneService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminSceneProtos.CreateRecommenderRecommendProductRequest.Builder request = AdminSceneProtos.CreateRecommenderRecommendProductRequest.newBuilder()
		...
		AdminSceneProtos.CreateRecommenderRecommendProductResponse response = Futures.getUnchecked(this.adminSceneService.createRecommenderRecommendProduct(this.adminHeadProvider.get(),
				request.build()));

...
public class MigrateDiscoverModuleCategoryServlet extends HttpServlet {
	
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminDiscoverService adminDiscoverService;

	@Inject
	public MigrateDiscoverModuleCategoryServlet(Provider<AdminHead> adminHeadProvider, AdminDiscoverService adminDiscoverService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminDiscoverProtos.MigrateModuleCategoryRequest request = AdminDiscoverProtos.MigrateModuleCategoryRequest.newBuilder()
					.addAllCategoryId(categoryIdList)
					.setModuleId(moduleId)
					.build();
		
		AdminDiscoverProtos.MigrateModuleCategoryResponse response = Futures.getUnchecked(this.adminDiscoverService.migrateModuleCategory(head, request));

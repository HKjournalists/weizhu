...
public class CreatePositionServlet extends HttpServlet {
	...
	@Inject
	public CreatePositionServlet(Provider<AdminHead> adminHeadProvider, AdminUserService adminUserService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		CreatePositionRequest request = CreatePositionRequest.newBuilder()
				.setPositionName(positionName)
				.setPositionDesc(positionDesc)
				.build();
		
		CreatePositionResponse response = Futures.getUnchecked(adminUserService.createPosition(head, request));

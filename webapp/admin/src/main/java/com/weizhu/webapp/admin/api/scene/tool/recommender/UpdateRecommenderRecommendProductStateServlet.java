...
public class UpdateRecommenderRecommendProductStateServlet extends HttpServlet {
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminSceneService adminSceneService;

	@Inject
	public UpdateRecommenderRecommendProductStateServlet(Provider<AdminHead> adminHeadProvider, AdminSceneService adminSceneService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminSceneProtos.UpdateRecommenderRecommendProductStateRequest.Builder request = AdminSceneProtos.UpdateRecommenderRecommendProductStateRequest.newBuilder()
		...
		AdminSceneProtos.UpdateRecommenderRecommendProductStateResponse response = Futures.getUnchecked(this.adminSceneService.updateRecommenderRecommendProductState(this.adminHeadProvider.get(),
				request.build()));

...
public class GetSoreByIdServlet extends HttpServlet {
	...
	@Inject
	public GetSoreByIdServlet(Provider<AdminHead> adminHeadProvider,
	...
	public void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		GetScoreByIdResponse response = Futures.getUnchecked(adminComponentService.getScoreById(head, GetScoreByIdRequest.newBuilder()

...
public class UpdateRecommenderCategoryServlet extends HttpServlet {
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminSceneService adminSceneService;

	@Inject
	public UpdateRecommenderCategoryServlet(Provider<AdminHead> adminHeadProvider, AdminSceneService adminSceneService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminSceneProtos.UpdateRecommenderCategoryRequest.Builder request = AdminSceneProtos.UpdateRecommenderCategoryRequest.newBuilder()
				.setCategoryName(categoryName)
				.setImageName(imageName)
				.setCategoryDesc(categoryDesc)
				.setCategoryId(categoryId);

		AdminSceneProtos.UpdateRecommenderCategoryResponse response = Futures.getUnchecked(this.adminSceneService.updateRecommenderCategory(this.adminHeadProvider.get(),
				request.build()));

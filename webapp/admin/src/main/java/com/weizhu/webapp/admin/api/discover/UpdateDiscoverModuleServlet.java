...
public class UpdateDiscoverModuleServlet extends HttpServlet {
	
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminDiscoverService adminDiscoverService;

	@Inject
	public UpdateDiscoverModuleServlet(Provider<AdminHead> adminHeadProvider, AdminDiscoverService adminDiscoverService) {
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminDiscoverProtos.UpdateModuleRequest.Builder requestBuilder = AdminDiscoverProtos.UpdateModuleRequest.newBuilder()
		...
		AdminDiscoverProtos.UpdateModuleResponse response = Futures.getUnchecked(this.adminDiscoverService.updateModule(head, requestBuilder.build()));

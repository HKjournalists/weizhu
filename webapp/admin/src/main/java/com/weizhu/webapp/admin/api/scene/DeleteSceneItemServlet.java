...
public class DeleteSceneItemServlet extends HttpServlet {
	private final Provider<AdminHead> adminHeadProvider;
	private final AdminSceneService adminSceneService;

	@Inject
	public DeleteSceneItemServlet(Provider<AdminHead> adminHeadProvider, AdminSceneService adminSceneService) {

...
public class GetDiscoverItemByIdsServlet extends HttpServlet {
	...
	@Inject
	public GetDiscoverItemByIdsServlet(Provider<AdminHead> adminHeadProvider, 
	...
	protected void doPost(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
		...
		AdminDiscoverProtos.GetItemByIdRequest request = AdminDiscoverProtos.GetItemByIdRequest.newBuilder()
				.addAllItemId(itemIdList)
				.build();
		AdminDiscoverProtos.GetItemByIdResponse response = Futures.getUnchecked(this.adminDiscoverService.getItemById(head, request));
		...
		for (DiscoverV2Protos.Item item : response.getItemList()) {
			...
			if (categoryIdList != null) {
				for (Integer categoryId : categoryIdList) {
					DiscoverV2Protos.Module.Category category = refCategoryMap.get(categoryId);

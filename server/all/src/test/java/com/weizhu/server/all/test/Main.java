package com.weizhu.server.all.test;
...
import com.weizhu.server.all.Main.ServerModule;

public class Main {
	
	public static void main(String[] args) {
		if (System.getProperty("logback.configurationFile") == null) {
			System.setProperty("logback.configurationFile", "com/weizhu/server/all/test/logback.xml");
		}
		if (args.length <= 0) {

...
public class CompanyServiceLocalModule extends AbstractModule {

	@Override
	protected void configure() {
		bind(CompanyServiceLocalImpl.class).in(Singleton.class);
	...
	@Provides
	@Singleton
	public CompanyService provideCompanyService(CompanyServiceLocalImpl serviceImpl, @Named("service_executor") Executor serviceExecutor) {
	...
	public ServiceInvoker provideCompanyServiceInvoker(CompanyServiceLocalImpl serviceImpl, @Named("service_executor") Executor serviceExecutor, @Nullable InfluxDBReporter influxDBReporter) {
